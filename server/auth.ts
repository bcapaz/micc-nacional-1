...
import { auth as authRouter } from "./auth"; // CORRIGIDO: Importa 'auth' e renomeia para 'authRouter'
import { routes as api } from "./routes";   // CORRIGIDO: Importa 'routes' e renomeia para 'api'
